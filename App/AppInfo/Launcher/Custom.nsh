...
${SegmentInit}
	...
	ClearErrors
	; Get some parameters which we are missing
	...
	${ReadLauncherConfig} $ProgramExecutable64 Launch ProgramExecutable64

	${If} $JavaMode == find
	${OrIf} $JavaMode == require
		${If} $Bits == 64
		${AndIfNot} $ProgramExecutable64 == ""
			${FindCommonJavaDirectory} $Bits
	                StrCpy $ProgramExecutable $ProgramExecutable64
			${DebugMsg} "Using 64-bit Java"
		${Else}
